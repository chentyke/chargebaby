...
export function DocBreadcrumb({ breadcrumb }: DocBreadcrumbProps) {
  ...
  return (
    <nav aria-label="Breadcrumb">
      <ol className="flex flex-wrap items-center gap-2 text-sm font-medium text-gray-500">
        <li className="flex items-center gap-1.5">
          <Link
            href="/docs"
            className="flex items-center gap-1.5 no-underline hover:text-blue-600 transition-colors"
          >
